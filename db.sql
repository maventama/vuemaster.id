...
--
-- Host: localhost    Database: vuemaster
-- ------------------------------------------------------
...
--
-- Table structure for table `cheat_sheets`
--

DROP TABLE IF EXISTS `cheat_sheets`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cheat_sheets` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cheat_sheet` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `cheat_sheets`
--

LOCK TABLES `cheat_sheets` WRITE;
/*!40000 ALTER TABLE `cheat_sheets` DISABLE KEYS */;
/*!40000 ALTER TABLE `cheat_sheets` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `courses` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `time_course` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_free` enum('yes','no') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'no',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `member_purchases` (
  ...
  `is_life_time` enum('yes','no') COLLATE utf8mb4_unicode_ci NOT NULL,
  `start_active` datetime DEFAULT NULL,
  `end_active` datetime DEFAULT NULL,
  `nominal` int NOT NULL,
  `is_paid` enum('yes','no','expired','waiting') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
LOCK TABLES `member_purchases` WRITE;
/*!40000 ALTER TABLE `member_purchases` DISABLE KEYS */;
/*!40000 ALTER TABLE `member_purchases` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `member_watch_videos`
--

DROP TABLE IF EXISTS `member_watch_videos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `member_watch_videos` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `member_id` int NOT NULL,
...
--
-- Dumping data for table `member_watch_videos`
--

LOCK TABLES `member_watch_videos` WRITE;
/*!40000 ALTER TABLE `member_watch_videos` DISABLE KEYS */;
/*!40000 ALTER TABLE `member_watch_videos` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `pricings` (
  ...
  `price` int NOT NULL,
  `price_decs` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pricing_label` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `pricing_promo` int NOT NULL DEFAULT '0',
...
--
-- Table structure for table `short_tips`
--

DROP TABLE IF EXISTS `short_tips`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `short_tips` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `short_tip` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
--
-- Dumping data for table `short_tips`
--

LOCK TABLES `short_tips` WRITE;
/*!40000 ALTER TABLE `short_tips` DISABLE KEYS */;
/*!40000 ALTER TABLE `short_tips` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-12-12  9:20:35
